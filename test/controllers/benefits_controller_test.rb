...
class BenefitsControllerTest < ActionController::TestCase
  ...
  test "should create benefit" do
    assert_difference('Benefit.count') do
      post :create, benefit: { descripcion: @benefit.descripcion, estatus: @benefit.estatus, texto: @benefit.texto }
    end
  ...
  test "should update benefit" do
    patch :update, id: @benefit, benefit: { descripcion: @benefit.descripcion, estatus: @benefit.estatus, texto: @benefit.texto }
    assert_redirected_to benefit_path(assigns(:benefit))
  end
