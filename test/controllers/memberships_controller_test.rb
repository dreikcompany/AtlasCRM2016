...
class MembershipsControllerTest < ActionController::TestCase
  ...
  test "should create membership" do
    assert_difference('Membership.count') do
      post :create, membership: { estatus: @membership.estatus, monto: @membership.monto, nombre: @membership.nombre }
    end
  ...
  test "should update membership" do
    patch :update, id: @membership, membership: { estatus: @membership.estatus, monto: @membership.monto, nombre: @membership.nombre }
    assert_redirected_to membership_path(assigns(:membership))
  end
